  ...
  (() => {
    ...
    new (class extends class {
      ...
      _replaceScript(e) {
        ...
        this.iframe = this._createIframe(v, n, i, l, T, k);
        const x = this._iframeSrcHost(n, i);
        this._addCSPErrorListener(x), h && this.iframe.setAttribute("nonce", h);
        const A = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
        if (
          (A
            ? ((0, t.ensureNotNull)(A.parentElement).replaceChild(this.iframe, A),
              null == s || s.remove())
            : u
            ? (this.iframeContainer.appendChild(this.iframe), null == s || s.remove())
            : (this.iframeContainer.appendChild(this.iframe),
              c.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(s))),
      ...
      _iframeSrcHost(t, e) {
        ...
        const r =
          t.host.includes("beta.tradingview.com") || t.host.includes("betacdn.tradingview.com");
        return "staging" === e && r
      ...
      _tryFixCSPIssueWithFallback(t) {
        ...
        e && this.iframe.setAttribute("src", e.replace(t, "https://s.tradingview.com"));
      }
